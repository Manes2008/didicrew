...
export default function DashboardPage() {
  ...
  return (
    <div className="space-y-8 animate-in fade-in duration-500">
      {/* Hero Banner */}
      <div className="glass-panel p-8 relative overflow-hidden border-[var(--vc-border)]">
        ...
        <div className="max-w-2xl space-y-4">
          ...
          <div className="pt-2 flex items-center gap-4">
            ...
            <Link
              href="/channels"
              className="px-5 py-2.5 rounded-xl font-semibold text-sm text-zinc-300 hover:text-white bg-white/[0.05] hover:bg-white/[0.08] transition border border-white/10 flex items-center gap-2"
            >
